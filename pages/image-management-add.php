...
if (isset($_POST['ssg_form_submit']) && $_POST['ssg_form_submit'] == 'yes')
{
	...
	$form['ssg_path'] = isset($_POST['ssg_path']) ? esc_url_raw($_POST['ssg_path']) : '';
	if ($form['ssg_path'] == '')
	{
	...
	$form['ssg_link'] = isset($_POST['ssg_link']) ? esc_url_raw($_POST['ssg_link']) : '';
	if ($form['ssg_link'] == '')
	{
	...
	$form['ssg_target'] = isset($_POST['ssg_target']) ? sanitize_text_field($_POST['ssg_target']) : '';
	if($form['ssg_target']!= "_blank" && $form['ssg_target'] != "_parent" && $form['ssg_target'] != "_self" && $form['ssg_target'] != "_new")
	{
		$form['ssg_target'] = "_blank";
	}
	
	$form['ssg_title'] = isset($_POST['ssg_title']) ? sanitize_text_field($_POST['ssg_title']) : '';
	
	$form['ssg_order'] = isset($_POST['ssg_order']) ? intval($_POST['ssg_order']) : '';
	
	$form['ssg_status'] = isset($_POST['ssg_status']) ? sanitize_text_field($_POST['ssg_status']) : '';
	if($form['ssg_status'] != "YES" && $form['ssg_status'] != "NO")
	{
		$form['ssg_status'] = "YES";
	}
	
	$form['ssg_type'] = isset($_POST['ssg_type']) ? sanitize_text_field($_POST['ssg_type']) : '';
